...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Wed Jun 14 12:37:43 2017
# Project:  nuke.pro
# Template: lib
...
CFLAGS        = -pipe -O2 -O2 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
...
LINK          = g++
LFLAGS        = -Wl,-O1 -shared -Wl,-soname,libsplish_splash.so.so.1
